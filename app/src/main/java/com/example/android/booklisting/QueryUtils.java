...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return an {@link Event} object to represent a single book.
     */
        ...
        try {
            ...
            for (int i = 0; i < booklistArray.length(); i++) {
                ...
                JSONObject volumeInfo = currentBook.getJSONObject("volumeInfo");
                   ...
                   // JSONObject bookInfo = volumeInfo.getJSONObject("imagelinks");
                    ...
                    String thumbs = imageObject.optString("thumbnail");




                String bookPublisher = volumeInfo.optString("title");
                     String bookAuthors = volumeInfo.optString("authors");
                    String publishedDate = volumeInfo.optString("categories");
                ...
                Book book = new Book( thumbs,bookPublisher,bookAuthors,publishedDate , infoLink);
